...
impl YagnaSettings {
    pub fn new(data_dir: &str, api_port: u16, gsb_port: u16, app_key: &str) -> Self {
        Self {
...
pub async fn test_run() {
    let mut yagna_runner = YagnaRunner::new(PathBuf::from("yagna.exe"), YagnaRunnerData{
        command: YagnaCommand::Server,
        settings: YagnaSettings::new("yagna-runner-test", 24665, 24666, "PPBf7M3zkrx2"),
    });
